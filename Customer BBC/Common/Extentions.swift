...
extension String {
    func strikeThrough() -> NSAttributedString {
        ...
        attributeString.addAttribute(NSAttributedString.Key.foregroundColor, value: hexStringToUIColor(hex: Color.lightGrey.rawValue), range: NSMakeRange(0,attributeString.length))
